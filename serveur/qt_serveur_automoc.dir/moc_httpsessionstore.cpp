...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_HttpSessionStore_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 35, 0)
    ...
    "HttpSessionStore\0sessionTimerEvent\0\0"
};
...
const QMetaObject HttpSessionStore::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_HttpSessionStore.data,
      qt_meta_data_HttpSessionStore,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_HttpSessionStore.stringdata))
