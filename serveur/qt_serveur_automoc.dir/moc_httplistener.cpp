...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_HttpListener_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 49, 16)
    ...
    "tSocketDescriptor\0socketDescriptor\0"
};
...
const QMetaObject HttpListener::staticMetaObject = {
    { &QTcpServer::staticMetaObject, qt_meta_stringdata_HttpListener.data,
      qt_meta_data_HttpListener,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_HttpListener.stringdata))
