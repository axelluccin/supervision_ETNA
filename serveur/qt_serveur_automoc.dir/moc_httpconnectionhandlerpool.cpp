...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_HttpConnectionHandlerPool_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 34, 0)
    ...
    "HttpConnectionHandlerPool\0cleanup\0\0"
};
...
const QMetaObject HttpConnectionHandlerPool::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_HttpConnectionHandlerPool.data,
      qt_meta_data_HttpConnectionHandlerPool,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_HttpConnectionHandlerPool.stringdata))
