...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_StaticFileController_t, stringdata) + ofs \
...
const QMetaObject StaticFileController::staticMetaObject = {
    { &HttpRequestHandler::staticMetaObject, qt_meta_stringdata_StaticFileController.data,
      qt_meta_data_StaticFileController,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StaticFileController.stringdata))
